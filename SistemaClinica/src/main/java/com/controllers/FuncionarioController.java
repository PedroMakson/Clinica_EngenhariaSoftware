...
public class FuncionarioController {
    ...
    public static void cadastrarFuncionario() throws SQLException {
        ...
        do {
            ...
            if (email.contains("@") && email.indexOf("@") > 0 && email.indexOf("@") < email.length() - 1
                ...
                try {
                    emailExistente = funcionarioDAO.verificarEmail(email);
    ...
    public static void visualizarDadosDoFuncionario() throws SQLException {
        ...
        do {
            ...
            if (verificarExistenciaCPF(cpf) == false) {
                App.limparTela();
        ...
        } while (verificarExistenciaCPF(cpf) == false);
                ...
                switch (opcao) {
                    ...
                    case 7: // E-mail
                        ...
                        do {
                            ...
                            try {
                                emailExistente = funcionarioDAO.verificarEmail(novoValor);
                            } catch (SQLException e) {
                                System.out.println(
